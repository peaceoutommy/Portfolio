...
/**
 * CustomColorPicker - A beautiful custom color picker component
 */
const CustomColorPicker = ({ 
  ...
  return (
    <motion.div
      className="p-3 bg-black/95 backdrop-blur-md rounded-lg border border-gray-700/50 select-none"
    ...
    >
      ...
      <div className="mb-3 flex items-center gap-2">
        <div
          className="w-8 h-8 rounded-lg border-2 border-gray-600/50 shadow-lg"
          style={{ backgroundColor: currentColor }}
        />
        <div className="flex-1">
          <GlowText className="text-xs font-medium mb-1">Custom Color</GlowText>
          <div className="text-xs text-gray-400 font-mono">{hexValue.toUpperCase()}</div>
        </div>
      </div>
